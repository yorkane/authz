  ...
  const messages = {
    'zh-CN': {
      ...
      authorization: {
        ...
        rrHeaders: 'Request headers', rrHeadersHint: 'Override request headers sent upstream; tick remove to delete one. Gateway-managed headers such as Host, Cookie, X-Authz-*, and X-Forwarded-* cannot be rewritten.',
        ...
        rrHeaders: '请求头改写', rrHeadersHint: '覆盖发往上游的请求头；勾选删除可移除该头。Host、Cookie、X-Authz-*、X-Forwarded-* 等由网关控制的头不可改写。',
